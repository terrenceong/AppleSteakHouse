...
public class RRPSSApp {
    	...
    	try {
            ...
            while(!quit)
            {
                ...
                switch(choice)
                {
                    ...
                    case 11: closeOrderInvoice();break;
                    case 12: listInvoices();break;
                    case 13: salesReport();break;
                    default: quit = true;
                }
            }
    	}
    ...
    private static void printOption(Staff s) {
        ...
        System.out.println("12 -> View order invoices");
        System.out.println("13 -> Print sale revenue report by period");
